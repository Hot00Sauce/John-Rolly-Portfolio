    ...
    return (
        <div href="#contact" id="contact" className="h-145 mt-10 md:h-160 xl:h-185
         bg-gradient-to-b from-gray-900 to-gray-950 justify-center items-center block">
                ...
                <div id="social media icon" className="flex w-25 justify-center items-center gap-2 justify-items-center
                    ...
                    <a href="https://www.instagram.com/jo_0.0_hn/">
                        <svg className="duration-300 text-gray-400
                                        cursor-pointer hover:text-[#1ABC9C]"
                    ...
                    <a id="gitlab" href="https://gitlab.com/Hot00Sauce">
                        <svg className="text-gray-400 hover:text-[#1ABC9C] duration-300 cursor-pointer" width="52" height="52" viewBox="0 0 52 52" fill="urrentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="https://www.linkedin.com/in/john00rolly/">
                        <svg
                            className="text-gray-400 hover:text-[#1ABC9C] duration-300 cursor-pointer" width="44" height="44" viewBox="0 0 44 44" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <footer id="footer" className="w-full text-center py-2 bg-gray-950 text-sm text-gray-400 mt-7">
