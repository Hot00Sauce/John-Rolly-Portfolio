        ...
        <div href="#contact" id="contact" className="h-145 mt-0 md:h-160 xl:h-185
         bg-gradient-to-b from-gray-900 to-gray-950 justify-center items-center block">
            ...
            <div id="text area message" className="justify-items-center">
                ...
                <div id="social media icon" className="flex items-center justify-center gap-4 mx-auto pt-4 sm:pt-3 md:pt-4 lg:pt-5">
                    <a href="https://www.instagram.com/jo_0.0_hn/">
                        <svg className="duration-300 text-gray-400 cursor-pointer hover:text-[#1ABC9C]"
                    ...
                    <a id="gitlab" href="https://gitlab.com/Hot00Sauce">
                        <svg className="text-gray-400 hover:text-[#1ABC9C] duration-300 cursor-pointer" width="55" height="55" viewBox="0 0 52 52" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            <path d="M26 43.3333C30.5971 43.3333 35.0059 41.5071 38.2565 38.2565C41.5071 35.0059 43.3333 30.5971 43.3333 26C43.3333 21.4029 41.5071 16.9941 38.2565 13.7435C35.0059 10.4928 30.5971 8.66665 26 8.66665C21.4029 8.66665 16.9941 10.4928 13.7435 13.7435C10.4928 16.9941 8.66665 21.4029 8.66665 26C8.66665 30.5971 10.4928 35.0059 13.7435 38.2565C16.9941 41.5071 21.4029 43.3333 26 43.3333ZM26 47.6666C14.0335 47.6666 4.33331 37.9665 4.33331 26C4.33331 14.0335 14.0335 4.33331 26 4.33331C37.9665 4.33331 47.6666 14.0335 47.6666 26C47.6666 37.9665 37.9665 47.6666 26 47.6666Z" fill="currentColor" />
                            <path d="M26 36.0013L22.0112 23.725H29.9888L26 36.0013ZM26 36.0013L16.419 23.725H22.009L26 36.0013ZM16.419 23.725L26 36.0013L15.5068 28.379C15.3655 28.2763 15.2604 28.1314 15.2067 27.9651C15.153 27.7989 15.1534 27.6198 15.2078 27.4538L16.4212 23.7228L16.419 23.725ZM16.419 23.725L18.824 16.3302C18.8506 16.247 18.9029 16.1744 18.9734 16.1229C19.0438 16.0714 19.1289 16.0437 19.2162 16.0437C19.3035 16.0437 19.3885 16.0714 19.459 16.1229C19.5295 16.1744 19.5818 16.247 19.6083 16.3302L22.0112 23.725L16.4212 23.7228L16.419 23.725ZM26 36.0013L29.9888 23.725L35.5788 23.7228L26 36.0013ZM35.581 23.7228L36.7943 27.4538C36.8484 27.6203 36.8481 27.7996 36.7936 27.9659C36.7391 28.1322 36.6331 28.2769 36.491 28.379L26 36.0013L35.581 23.7228ZM35.581 23.7228H29.991L32.3917 16.328C32.4177 16.244 32.4699 16.1706 32.5406 16.1184C32.6114 16.0662 32.697 16.0381 32.7849 16.0381C32.8728 16.0381 32.9585 16.0662 33.0292 16.1184C33.1 16.1706 33.1522 16.244 33.1782 16.328L35.581 23.7228Z" fill="currentColor" />
                        </svg>

                    </a>
                    <a href="https://github.com/Hot00Sauce">
                        <svg className="text-gray-400 hover:text-[#1ABC9C] duration-300 cursor-pointer" width="44" height="44" viewBox="0 0 44 44" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="/John_Rolly_Cedillo_Resume.pdf" download="John_Rolly_Cedillo_Resume.pdf" title="Download Resume">
            ...
            <footer id="footer" className="w-full text-center py-2 bg-gray-950 text-sm text-gray-400 mt-7 pb-15 md:pb-15 lg:-pb-10 xl:-pb-10">
